<section class="contact-section" id="consultation">
    <div class="container container--narrow">
        <div class="contact-box">
            <div class="contact-box__title-wrapper">
                <h2 class="contact-box__title">ご相談・お問い合わせ</h2>
                <p class="contact-box__subtitle">お気軽にご連絡ください</p>
            </div>
            <div class="contact-box__button-wrapper">
                <a href="tel:0282123456" class="contact-button contact-button--tel">
                ...
                <a href="apply.php" class="contact-button">
                    <span class="contact-button__icon">
